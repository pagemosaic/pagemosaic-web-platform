...
type OnLinkCallbackFn = (url: string) => void;

interface TipTapEditorProps {
    controlKey: number;
    content: string;
    onChange: (html: string) => void;
    // onBlur: (value: string, valueIsChanged: boolean) => void;
    // onFocus?: () => void;
...
export function TipTapEditor(props: TipTapEditorProps) {
    ...
    // const onBlurCallbackRef = useRef<any>();
    const editor = useEditor({
        ...
        //     const newOutput: string = editor.getHTML();
        //     onBlur(newOutput, content !== newOutput);
        // },
    });
    ...
    //             editor.off('blur', onBlurCallbackRef.current);
    //         }
    //         onBlurCallbackRef.current = ({editor: updatedEditor}: any) => {
    //             const newOutput: string = updatedEditor.getHTML();
    //             onBlur(newOutput, content !== newOutput);
    //         };
    //         editor.on('blur', onBlurCallbackRef.current);
    //     }
    // }, [editor, onBlur]);
    ...
    return (
        <>
            {editor &&
                <BubbleMenu editor={editor} tippyOptions={{duration: 100, maxWidth: 'none', zIndex: 700}}>
